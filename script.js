...
function submitEntry() {
    ...
    // --- FIX START ---
    const now = new Date();
    // Format the date and time to a more readable local string
    // Example: "20/05/2025 17:12:58" (Day/Month/Year Hour:Minute:Second)
    // You can adjust the format as per your preference (e.g., US format, 12-hour clock with AM/PM)
    ...
    // Combine into a string format, e.g., "DD/MM/YYYY HH:MM:SS"
    ...
    formData.append('timestamp', formattedTimestamp); // Use the formatted timestamp here
